...
/**
 * Created by jiahong on 19/08/17.
 */
...
public class Init implements UpdateCallbackInterface
{
    ...
    private Controller mSessionControl;
    ...
    public Init(Controller sessionControl)
    {
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
                do
                {
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            } else
            {
                ...
                Vuforia.registerCallback(Init.this);
